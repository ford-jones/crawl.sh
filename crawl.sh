...
echo -e "\e[1;34m Welcome to crawl.sh \e[0m"
echo -e "\e[1;34m Paste url's below and hit enter to clone html directly from the web.\e[0m"
echo -e "\e[1;34m Press [Ctrl + C] to escape.\e[0m"
...
do
    ...
    then
        ...
        echo -e "\e[1;32m Snapshot success! \e[0m"
    else
